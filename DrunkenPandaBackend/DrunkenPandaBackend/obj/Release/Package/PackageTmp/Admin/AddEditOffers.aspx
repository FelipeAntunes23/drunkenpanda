<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/DrunkenPanda.Master" AutoEventWireup="true" CodeBehind="AddEditOffers.aspx.cs" Inherits="DrunkenPandaBackend.Admin.AddEditOffers" %>
                    ...
                    <div class="kt-portlet">
                        <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title">Add Edit Offer
                                </h3>
                            </div>
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="col-lg-12 row">
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadTextBox ID="txtDescription" runat="server" CssClass="form-control" Width="100%"></telerik:RadTextBox>
                                ...
                                <div class="col-lg-4 form-group">
                                    <label class="control-label col-lg-12">Offer Image <span class="required">* </span></label>
    ...
    <div class="modal fade" id="kt_modal_1_4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span>Your Offer Has Been Updated Successfully.</span>
                </div>
                <div class="modal-footer">
