<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/DrunkenPanda.Master" AutoEventWireup="true" CodeBehind="AddEditCategory.aspx.cs" Inherits="DrunkenPandaBackend.Admin.AddEditCategory" %>
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="col-lg-12 row">
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadTextBox ID="txtCategory" runat="server" CssClass="form-control" Width="100%"></telerik:RadTextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                                            ControlToValidate="txtCategory" ErrorMessage="Please Enter Category Name" ForeColor="Red" Display="Dynamic"
    ...
    <div class="modal fade" id="kt_modal_1_4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span>Your Category Has Been Updated Successfully.</span>
                </div>
                <div class="modal-footer">
