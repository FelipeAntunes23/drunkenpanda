<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/DrunkenPanda.Master" AutoEventWireup="true" CodeBehind="UpdatePassword.aspx.cs" Inherits="DrunkenPandaBackend.Admin.UpdatePassword" %>
				...
				<div class="kt-portlet">
					...
					<div class="kt-portlet__body">
						...
						<div class="col-lg-12 form-actions">
							<div class="col-lg-12 row">
								<div class="col-md-9">
									<asp:LinkButton ID="btnSave" Width="100px" runat="server" OnClick="btnSave_Click" Text='<i class="icon-ok"></i>Save' CssClass="btn btn-brand btn-elevate btn-icon-sm" />
